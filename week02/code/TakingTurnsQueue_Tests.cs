...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue was putting the persons at the back of the queue instead of the front.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson was not accounting for 0 to be forever. 
